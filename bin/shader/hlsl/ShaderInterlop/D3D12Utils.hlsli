...
namespace interlop
{
    ...
    ConstantBufferStruct D3D12_DRAW_ARGUMENTS
    {
    ...
    ConstantBufferStruct D3D12_DRAW_INDEXED_ARGUMENTS
    {
    ...
    ConstantBufferStruct D3D12_DISPATCH_ARGUMENTS
    {
    ...
    ConstantBufferStruct D3D12_DISPATCH_MESH_ARGUMENTS
    {
        uint ThreadGroupCountX;
        uint ThreadGroupCountY;
        uint ThreadGroupCountZ;
    ...
    ConstantBufferStruct D3D12_VERTEX_BUFFER_VIEW
    {
    ...
    ConstantBufferStruct D3D12_INDEX_BUFFER_VIEW
    {
        D3D12_GPU_VIRTUAL_ADDRESS BufferLocation;
        uint                      SizeInBytes;
        uint                      Format;
    ...
    ConstantBufferStruct D3D12_RAYTRACING_INSTANCE_DESC
    {
        float3x4 Transform;
