...
#define CONFIG_MAX_INSTANCES 64
...
struct LightsUniforms
{
    ...
    float4 colorIES;        // { half3(col),  IES index   }
...
// static_assert(sizeof(PerRenderableMorphingUib) <= CONFIG_MINSPEC_UBO_SIZE, "PerRenderableMorphingUib exceeds max UBO
// size");
