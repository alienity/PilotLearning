...
Cubemap::Address Cubemap::getAddressFor(const glm::float3& r) {
...
Cubemap::Texel Cubemap::trilinearFilterAt(const Cubemap& l0, const Cubemap& l1, float lerp, const glm::float3& L)
{
    ...
    glm::float3 c0 = filterAt(i0, x0, y0);
