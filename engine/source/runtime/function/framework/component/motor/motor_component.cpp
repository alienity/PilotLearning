...
namespace Pilot
{
    ...
    void MotorComponent::calculatedDesiredMoveDirection(unsigned int command, const Quaternion& object_rotation)
    {
        ...
        {
            Vector3 forward_dir = object_rotation * Vector3::Forward;
            Vector3 left_dir    = object_rotation * Vector3::Left;
            ...
            m_desired_horizontal_move_direction.normalize();
        }
    }
    ...
    void MotorComponent::calculateDesiredDisplacement(float delta_time)
    {
        ...
        m_desired_displacement =
            ...
            Vector3::Up * m_vertical_move_speed * delta_time;
    }
