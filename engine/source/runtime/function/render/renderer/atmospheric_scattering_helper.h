...
namespace MoYu
{
    namespace AtmosphereScattering
    {
        ...
        struct AtmosphereScatteringConstants
        {
        ...
        public:
            ...
            AtmosphereParameters _atmosphereParameters;

            // ScriptableRendererData
            // precompute the atmosphere textures
            ...
            static double
            CieColorMatchingFunctionTableValue(double wavelength, int column, double kLambdaMin, double kLambdaMax);

            static double
            Interpolate(std::vector<double> wavelengths, std::vector<double> wavelength_function, double wavelength);

            static void ComputeSpectralRadianceToLuminanceFactors(std::vector<double> wavelengths,
                                                                  std::vector<double> solar_irradiance,
                                                                  double              kLambdaMin,
                                                                  double              kLambdaMax,
                                                                  double              lambda_power,
            ...
            static glm::float3
            ToVector3(std::vector<double> wavelengths, std::vector<double> v, glm::float3 lambdas, double scale);
            ...
            //static RenderTexture Copy3DSliceToRenderTexture(RenderTexture rt, int layer);

            //static void SaveRT2DToFile(RenderTexture rt, TextureFormat texFormat, string path);

            //static void SaveRT3DToFile(RenderTexture rt, TextureFormat texFormat, string path);
