...
namespace RHI
{
    ...
    inline D3D12_RESOURCE_STATES RHITranslateD3D12(const RHIResourceState& ResourceState)
    {
        ...
        {
            case RHIResourceState::RHI_RESOURCE_STATE_COMMON: _TargetState = D3D12_RESOURCE_STATE_COMMON; break;
            case RHIResourceState::RHI_RESOURCE_STATE_VERTEX_AND_CONSTANT_BUFFER: _TargetState = D3D12_RESOURCE_STATE_VERTEX_AND_CONSTANT_BUFFER; break;
            case RHIResourceState::RHI_RESOURCE_STATE_INDEX_BUFFER: _TargetState = D3D12_RESOURCE_STATE_INDEX_BUFFER; break;
            case RHIResourceState::RHI_RESOURCE_STATE_RENDER_TARGET: _TargetState = D3D12_RESOURCE_STATE_RENDER_TARGET; break;
            case RHIResourceState::RHI_RESOURCE_STATE_UNORDERED_ACCESS: _TargetState = D3D12_RESOURCE_STATE_UNORDERED_ACCESS; break;
            case RHIResourceState::RHI_RESOURCE_STATE_DEPTH_WRITE: _TargetState = D3D12_RESOURCE_STATE_DEPTH_WRITE; break;
            case RHIResourceState::RHI_RESOURCE_STATE_DEPTH_READ: _TargetState = D3D12_RESOURCE_STATE_DEPTH_READ; break;
            case RHIResourceState::RHI_RESOURCE_STATE_NON_PIXEL_SHADER_RESOURCE: _TargetState = D3D12_RESOURCE_STATE_NON_PIXEL_SHADER_RESOURCE; break;
            case RHIResourceState::RHI_RESOURCE_STATE_PIXEL_SHADER_RESOURCE: _TargetState = D3D12_RESOURCE_STATE_PIXEL_SHADER_RESOURCE; break;
            case RHIResourceState::RHI_RESOURCE_STATE_STREAM_OUT: _TargetState = D3D12_RESOURCE_STATE_STREAM_OUT; break;
            case RHIResourceState::RHI_RESOURCE_STATE_INDIRECT_ARGUMENT: _TargetState = D3D12_RESOURCE_STATE_INDIRECT_ARGUMENT; break;
            case RHIResourceState::RHI_RESOURCE_STATE_COPY_DEST: _TargetState = D3D12_RESOURCE_STATE_COPY_DEST; break;
            case RHIResourceState::RHI_RESOURCE_STATE_COPY_SOURCE: _TargetState = D3D12_RESOURCE_STATE_COPY_SOURCE; break;
            case RHIResourceState::RHI_RESOURCE_STATE_RESOLVE_DEST: _TargetState = D3D12_RESOURCE_STATE_RESOLVE_DEST; break;
            case RHIResourceState::RHI_RESOURCE_STATE_RESOLVE_SOURCE: _TargetState = D3D12_RESOURCE_STATE_RESOLVE_SOURCE; break;
            case RHIResourceState::RHI_RESOURCE_STATE_RAYTRACING_ACCELERATION_STRUCTURE: _TargetState = D3D12_RESOURCE_STATE_RAYTRACING_ACCELERATION_STRUCTURE; break;
            case RHIResourceState::RHI_RESOURCE_STATE_SHADING_RATE_SOURCE: _TargetState = D3D12_RESOURCE_STATE_SHADING_RATE_SOURCE; break;
            case RHIResourceState::RHI_RESOURCE_STATE_GENERIC_READ: _TargetState = D3D12_RESOURCE_STATE_GENERIC_READ; break;
            case RHIResourceState::RHI_RESOURCE_STATE_ALL_SHADER_RESOURCE: _TargetState = D3D12_RESOURCE_STATE_ALL_SHADER_RESOURCE; break;
            //case RHIResourceState::RHI_RESOURCE_STATE_PRESENT: break;
            //case RHIResourceState::RHI_RESOURCE_STATE_PREDICATION: break;
            default:
                break;
        }
        // clang-format on
