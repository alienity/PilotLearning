...
namespace RHI
{
    ...
    private:
        ...
        Compile(D3D12Device* Device, const std::wstring& Name, TDesc& Desc);
    ...
    struct DxilLibrary
    {
        DxilLibrary(const D3D12_SHADER_BYTECODE& Library, const std::vector<std::wstring_view>& Symbols) :
    ...
    {
        RootSignatureAssociation(ID3D12RootSignature* RootSignature, const std::vector<std::wstring_view>& Symbols) :
            RootSignature(RootSignature), Symbols(Symbols)
        {}
    ...
    public:
        ...
        RaytracingPipelineStateDesc& AddLibrary(const D3D12_SHADER_BYTECODE&          Library,
    ...
    public:
        ...
        explicit D3D12RaytracingPipelineState(D3D12Device* Parent, RaytracingPipelineStateDesc& Desc);
