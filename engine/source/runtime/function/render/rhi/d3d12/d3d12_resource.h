...
namespace RHI
{
    ...
    {
    public:
        static std::shared_ptr<BufferD3D12> CreateBuffer(D3D12LinkedDevice* Parent,
    ...
    protected:
        ...
        std::shared_ptr<D3D12Buffer> p_ResourceD3D12Buffer;

        std::shared_ptr<BufferD3D12> p_CounterBufferD3D12;
