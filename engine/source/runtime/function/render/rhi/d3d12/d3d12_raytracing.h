...
namespace RHI
{
    ...
    // We should rebuild the TLAS rather than update, It's just easier to manage in most circumstances, and the cost
    // savings to refit likely aren't worth sacrificing quality of TLAS.
    ...
    public:
        ...
        void Generate(ID3D12GraphicsCommandList4* CommandList,
    ...
    public:
        ...
        explicit D3D12RaytracingMemoryPage(D3D12LinkedDevice*    Parent,
                                           UINT64                PageSize,
    ...
    public:
        ...
        explicit D3D12RaytracingAllocator(D3D12LinkedDevice*    Parent,
                                          D3D12_HEAP_TYPE       HeapType,
                                          D3D12_RESOURCE_STATES InitialResourceState,
    ...
    private:
        ...
        bool FindFreeSubBlock(D3D12RaytracingMemoryPage* Page,
    ...
    public:
        ...
        explicit D3D12RaytracingManager(D3D12LinkedDevice* Parent, UINT64 PageSize);

        UINT64 Build(ID3D12GraphicsCommandList4*                                 CommandList,
        ...
        D3D12_GPU_VIRTUAL_ADDRESS GetAddress(UINT64 AccelerationStructureIndex);
    ...
    struct D3D12RaytracingShaderRecord
    {
        ...
        D3D12RaytracingShaderRecord(const ShaderIdentifier& ShaderIdentifier, const T& RootArguments) noexcept :
            ShaderIdentifier(ShaderIdentifier), RootArguments(RootArguments)
        {}
    ...
    public:
        ...
        static constexpr UINT64 StrideInBytes =
            D3D12RHIUtils::AlignUp<UINT64>(sizeof(Record), D3D12_RAYTRACING_SHADER_RECORD_BYTE_ALIGNMENT);

        D3D12RaytracingShaderTable(size_t NumShaderRecords) : ShaderRecords(NumShaderRecords) {}
