 ...
 */
uvec3 getWorkGroupID() { return gl_WorkGroupID; }

/**
 * @public-api
 * Number of work groups in each dimensions
 */
uvec3 getWorkGroupCount() { return gl_NumWorkGroups; }

/**
 * @public-api
 * Within the work group, get a unique identifier for the thread.
 */
uvec3 getLocalInvocationID() { return gl_LocalInvocationID; }
 ...
 */
uint getLocalInvocationIndex() { return gl_LocalInvocationIndex; }
 ...
 */
uvec3 getGlobalInvocationID() { return gl_GlobalInvocationID; }
