...
#ifndef DOWNSAMPLE_METHOD // 0 - average, 1 - max, 2 - min
#define DOWNSAMPLE_METHOD 0
#endif
...
SamplerState BilinearClamp : register(s10);
...
void main( uint GI : SV_GroupIndex, uint3 DTid : SV_DispatchThreadID )
{
    ...
    float4 Src1 = max(SrcMip.SampleLevel(BilinearClamp, UV1, SrcMipLevel), SrcMip.SampleLevel(BilinearClamp, UV1 + Off, SrcMipLevel));
#elif DOWNSAMPLE_METHOD == 2
    float4 Src1 = min(SrcMip.SampleLevel(BilinearClamp, UV1, SrcMipLevel), SrcMip.SampleLevel(BilinearClamp, UV1 + Off, SrcMipLevel));
#endif
...
#elif DOWNSAMPLE_METHOD == 1
    float4 Src1 = SrcMip.SampleLevel(BilinearClamp, UV1, SrcMipLevel);
    Src1 = max(Src1, SrcMip.SampleLevel(BilinearClamp, UV1 + float2(O.x, 0.0), SrcMipLevel));
    Src1 = max(Src1, SrcMip.SampleLevel(BilinearClamp, UV1 + float2(0.0, O.y), SrcMipLevel));
    Src1 = max(Src1, SrcMip.SampleLevel(BilinearClamp, UV1 + float2(O.x, O.y), SrcMipLevel));
#elif DOWNSAMPLE_METHOD == 2
    float4 Src1 = SrcMip.SampleLevel(BilinearClamp, UV1, SrcMipLevel);
    Src1 = min(Src1, SrcMip.SampleLevel(BilinearClamp, UV1 + float2(O.x, 0.0), SrcMipLevel));
    Src1 = min(Src1, SrcMip.SampleLevel(BilinearClamp, UV1 + float2(0.0, O.y), SrcMipLevel));
    Src1 = min(Src1, SrcMip.SampleLevel(BilinearClamp, UV1 + float2(O.x, O.y), SrcMipLevel));
#endif
#endif
