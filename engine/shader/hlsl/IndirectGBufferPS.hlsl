...
VaringStruct VSMain(VertexInput input)
{
    ...
    float4x4 prevLocalToWorldMatrix = renderableMeshData.prevWorldFromModelMatrix;
    float4 prev_ws_position = mul(prevLocalToWorldMatrix, float4(input.position, 1.0f));
