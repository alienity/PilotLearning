...
#include "../../Material/DiffusionProfile/DiffusionProfile.hlsl"
...
uint GetSubsurfaceScatteringTexturingMode(FrameUniforms frameUniform, int diffusionProfile)
{
    ...
    if (enableSss)
    {
        bool performPostScatterTexturing = IsBitSet(frameUniform.sssUniform._TexturingModeFlags, diffusionProfile);
