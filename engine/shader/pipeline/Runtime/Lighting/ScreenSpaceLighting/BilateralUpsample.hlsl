...
void EvaluateMaskValidity(float4 _ZBufferParams, float linearHighDepth, float lowDepth, int currentIndex,
...
void OverrideMaskValues(float4 _ZBufferParams, float highDepth, inout NeighborhoodUpsampleData3x3 data,
                        out float rejectedNeighborhood, out int closestNeighhor)
{
    ...
    EvaluateMaskValidity(_ZBufferParams, linearHighDepth, data.lowDepthB.x, 4, data.lowMasksB.x, closestNeighhor, currentDistance, rejectedNeighborhood);

    // Then the plus
    EvaluateMaskValidity(_ZBufferParams, linearHighDepth, data.lowDepthA.y, 1, data.lowMasksA.y, closestNeighhor, currentDistance, rejectedNeighborhood);
    EvaluateMaskValidity(_ZBufferParams, linearHighDepth, data.lowDepthA.w, 3, data.lowMasksA.w, closestNeighhor, currentDistance, rejectedNeighborhood);
    EvaluateMaskValidity(_ZBufferParams, linearHighDepth, data.lowDepthB.y, 5, data.lowMasksB.y, closestNeighhor, currentDistance, rejectedNeighborhood);
    EvaluateMaskValidity(_ZBufferParams, linearHighDepth, data.lowDepthB.w, 7, data.lowMasksB.w, closestNeighhor, currentDistance, rejectedNeighborhood);

    // Then the cross
    EvaluateMaskValidity(_ZBufferParams, linearHighDepth, data.lowDepthA.x, 0, data.lowMasksA.x, closestNeighhor, currentDistance, rejectedNeighborhood);
    EvaluateMaskValidity(_ZBufferParams, linearHighDepth, data.lowDepthA.z, 2, data.lowMasksA.z, closestNeighhor, currentDistance, rejectedNeighborhood);
    EvaluateMaskValidity(_ZBufferParams, linearHighDepth, data.lowDepthB.z, 6, data.lowMasksB.z, closestNeighhor, currentDistance, rejectedNeighborhood);
    EvaluateMaskValidity(_ZBufferParams, linearHighDepth, data.lowDepthC, 8, data.lowMasksC, closestNeighhor, currentDistance, rejectedNeighborhood);
}
