...
EnvLightData InitSkyEnvLightData(ShaderVariablesGlobal shaderVariablesGlobal, int envIndex)
{
    EnvLightData output;
    ...
    output.weight = 1.0;
    output.multiplier = shaderVariablesGlobal._EnableSkyReflection.x != 0 ? 1.0 : 0.0;
