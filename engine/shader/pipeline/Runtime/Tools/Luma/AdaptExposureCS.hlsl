...
{
    uint m_InputHistogramIndex;
    uint m_OutExposureIndex;
}
...
{
    ByteAddressBuffer         Histogram = ResourceDescriptorHeap[m_InputHistogramIndex];
    RWStructuredBuffer<float> Exposure  = ResourceDescriptorHeap[m_OutExposureIndex];
