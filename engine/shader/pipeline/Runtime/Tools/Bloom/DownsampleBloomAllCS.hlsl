...
{
    Texture2D<float3>   BloomBuf = ResourceDescriptorHeap[m_BloomBufIndex];
    RWTexture2D<float3> Result1  = ResourceDescriptorHeap[m_Result1Index];
    RWTexture2D<float3> Result2  = ResourceDescriptorHeap[m_Result2Index];
    RWTexture2D<float3> Result3  = ResourceDescriptorHeap[m_Result3Index];
    RWTexture2D<float3> Result4  = ResourceDescriptorHeap[m_Result4Index];
