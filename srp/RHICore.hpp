...
namespace RHI
{
    ...
    constexpr RHI_RESOURCE_STATES RHI_RESOURCE_STATE_UNKNOWN       = static_cast<RHI_RESOURCE_STATES>(-1);
    constexpr RHI_RESOURCE_STATES RHI_RESOURCE_STATE_UNINITIALIZED = static_cast<RHI_RESOURCE_STATES>(-2);
